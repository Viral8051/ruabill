...
const Dashboard = () => {
    ...
    const sortedInvoiceBillNo = [...filteredInvoices].sort(
        (a, b) =>
            Number(b.invoiceInfo.invoiceNo) -
            Number(a.invoiceInfo.invoiceNo)
    );
                ...
                <div className="container-main shadow-[0px_0px_22px_-15px_rgba(136,136,136,1)] rounded-3xl border-[var(--ternary-color)] p-5">
                    ...
                    <div className="dashboard-table relative z-0 w-full shadow-[inset_0_5px_10px_rgba(136,136,136,0.2)] rounded-2xl mt-2">
                        ...
                        <table className="w-full">
                            ...
                            <thead>
                                <tr>
                                    <th className="py-5 border-b border-[#212222]">
                                        Bill No.
                                    </th>
                            ...
                            <tbody className="tbody">
                                ...
                                {invoices.length === 0 ? (
                                    ...
                                    sortedInvoiceBillNo.map(
                                        (invoice: Invoice, index: number) => (

                                            <tr
                                                key={invoice.invoiceInfo.invoiceNo}
                                                className="text-center border-spacing-5 border-b border-[#212222] last:border-none"
                                            >
